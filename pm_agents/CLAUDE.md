...
- 연결 방식: **Atlassian 공식 원격 MCP**(Remote/Rovo MCP, `https://mcp.atlassian.com/v1/mcp`, **Streamable
  HTTP·OAuth** — 비밀값 없음. 구 `/v1/sse`는 2026-06-30 이후 지원 종료). 설치/인증·도구 목록은
  `docs/ATLASSIAN-MCP.md`. 인증은 각자 브라우저 1회.
